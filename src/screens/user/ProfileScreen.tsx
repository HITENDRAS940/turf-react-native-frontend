    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          onPress: () => Toast.show({ type: 'info', text1: 'Coming Soon', text2: 'Dark mode feature is under development' }),
        },
      ],
    },
    {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        <View style={styles.profileCard}>
          ...
          <Text style={styles.phone}>{formatPhoneForDisplay(user?.phone || '')}</Text>
      ...
      <View style={styles.footer}>
        <Text style={styles.version}>TurfBooking v1.0.0</Text>
      </View>
    </SafeAreaView>
  );
};
